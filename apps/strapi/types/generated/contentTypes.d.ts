...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::destination.destination'> &
      Schema.Attribute.Private;
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.Text & Schema.Attribute.CustomField<'plugin::tiptap-editor.RichText'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
